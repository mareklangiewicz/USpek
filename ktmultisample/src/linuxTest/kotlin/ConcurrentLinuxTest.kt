...
// FIXME NOW NOCOMMIT popatrzec jeszcze jak moznaby cala ta klase wrzucic do common (zrobic fakowy runblocking jednak w js??)
//  (ale znowu: nie zgubic wynikow benchmarkow)
//  pozmieniac tez koniecznie nazwy testow bo sa strasznie mylace i zrobic prawdziwe massive odpalanie coroutyn!
//  (plan z przed lat to bylo massive takie jak w dokumentacji cooroutines - czyli pokazanie odpalenia duzej ilosci korutyn - zrobic to z delayami)
